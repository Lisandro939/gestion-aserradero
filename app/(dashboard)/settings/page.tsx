				...
				<div className="lg:col-span-1 space-y-4 md:space-y-6">
					<section className="bg-[var(--card)] rounded-3xl p-6 shadow-sm border border-stone-200">
						...
						<div className="flex flex-col items-center text-center space-y-4">
							<div className="h-24 w-24 rounded-full bg-amber-100 flex items-center justify-center text-3xl font-bold text-amber-600">
								{user?.name.charAt(0)}
							</div>
							<div>
										...
										>
											...
											<div className="flex items-center gap-0">
												...
												<button
													...
													className="p-2 rounded-lg text-stone-400 hover:bg-amber-100 hover:text-amber-600 transition-all"
					...
					<div className="w-full max-w-md bg-[var(--card)] rounded-3xl shadow-2xl p-6 md:p-8 animate-in fade-in zoom-in duration-200 border border-stone-200">
						...
						<div className="space-y-4 mb-8">
							...
							<div className="bg-amber-50 border border-amber-100 rounded-xl p-4">
								...
								<p className="text-lg font-mono font-bold text-amber-600 select-all">
									{resetUser.tempPass}
								</p>
							</div>
							<p className="text-xs text-stone-500">
						...
						<div className="flex gap-3">
							<button
								onClick={() => setShowResetModal(false)}
								className="flex-1 px-4 py-2.5 rounded-xl font-bold text-stone-500 hover:bg-stone-100 transition-colors"
							>
								Cancelar
							</button>
							<button
