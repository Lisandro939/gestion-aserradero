			...
			<div className="flex flex-col gap-3 md:gap-4 md:flex-row md:items-center md:justify-between">
				...
				{activeTab === "view" ? (
					...
					<button
						...
						className="cursor-pointer flex items-center justify-center gap-2 rounded-xl bg-stone-100 px-4 md:px-5 py-2.5 text-sm font-bold text-stone-600 transition-all hover:bg-stone-200 w-full md:w-auto"
					>
